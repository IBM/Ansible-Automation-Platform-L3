...
Sellers: recall that the Git-cloned template had a commented-out line towards the end of the YAML definition: this line ```- role: was``` will link the new *was* Role (which you will define momentarily) to the litany of operations that the Ansible Playbook will perform and interact with.
...
Either path is appropriate, so tailor it to your job role or interests. Good luck!
